(function ($) {
  ...
  if ($('.up-comming-event-two').length) {
    $('.up-comming-event-two .tabs-button-box .tab-btn-item').on(
      'click',
      function (e) {
        e.preventDefault();
        ...
        if ($(target).hasClass('actve-tab')) {
          ...
          $('.up-comming-event-two .tabs-button-box .tab-btn-item').removeClass(
            'active-btn-item'
          );
          $(this).addClass('active-btn-item');
          $(
            '.up-comming-event-two .tabs-content-box .tab-content-box-item'
